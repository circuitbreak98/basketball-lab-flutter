...
class GeneralBoardCommentView extends StatefulWidget {
  final GeneralBoardModel post;

  const GeneralBoardCommentView({
    Key? key,
    required this.post,
  }) : super(key: key);

  @override
  State<GeneralBoardCommentView> createState() => _GeneralBoardCommentViewState();
}

class _GeneralBoardCommentViewState extends State<GeneralBoardCommentView> {
