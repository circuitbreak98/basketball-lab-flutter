...
class GeneralBoardWriteView extends StatefulWidget {
  final VoidCallback? onPostCreated;
  const GeneralBoardWriteView({Key? key, this.onPostCreated}) : super(key: key);

  @override
  State<GeneralBoardWriteView> createState() => _GeneralBoardWriteViewState();
}

class _GeneralBoardWriteViewState extends State<GeneralBoardWriteView> {
