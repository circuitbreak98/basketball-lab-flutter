...
class GuestBoardDetailView extends StatelessWidget {
  final GuestBoardModel post;

  const GuestBoardDetailView({Key? key, required this.post}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: GuestBoardCommentView(post: post),
            ),
          ],
        ),
      ),
